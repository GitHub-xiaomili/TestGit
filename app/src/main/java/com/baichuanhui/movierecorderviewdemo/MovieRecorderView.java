...
public class MovieRecorderView extends LinearLayout implements OnErrorListener {
	...
	public MovieRecorderView(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.MovieRecorderView2, defStyle, 0);
		mWidth = a.getInteger(R.styleable.MovieRecorderView2_width2, 320);// 默认320
		mHeight = a.getInteger(R.styleable.MovieRecorderView2_height2, 240);// 默认240

		isOpenCamera = a.getBoolean(
				R.styleable.MovieRecorderView2_is_open_camera, true);// 默认打开
		mRecordMaxTime = a.getInteger(
				R.styleable.MovieRecorderView2_record_max_time, 10);// 默认为10
